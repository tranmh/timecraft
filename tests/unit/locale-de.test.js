...
const { GRID, WORDS, timeToWords } = localeDe;

describe('German locale - grid structure', () => {
...
describe('German locale - word positions match grid', () => {
  test('each word maps to correct letters in grid', () => {
    const expected = {
      ES: 'ES', IST: 'IST', FUNF_M: 'FÜNF', ZEHN_M: 'ZEHN',
      ZWANZIG: 'ZWANZIG', VIERTEL: 'VIERTEL', NACH: 'NACH', VOR: 'VOR',
...
describe('German locale - timeToWords', () => {
  const cases = [
    ...
    { h: 12, m: 45, expect: ['ES', 'IST', 'VIERTEL', 'VOR', 'EINS'] },
